    ...
    return (
        <div>
            ...
            <Container fluid>
                <Row className="mt-5">
                    <Col
                        className="ms-auto d-flex justify-content-center max-w-md "
                        sm={8}
                    >
                        <Col sm={8}>
                            <div className="">
                                <ReactPlayer
                                    className="video"
                                    url="https://www.youtube.com/embed/kRsq3HxZX_U"
                                    controls
                                />
                            </div>
                            {/* <div className="mt-2">
                            ...
                            <div className="">
                                ...
                                <p className="text-class">
                                    Welcome to Capable Academy. Before starting
                                    the learning in this class, your child needs
                                    to know the stages and methods of learning,
                                    along with the available facilities to make
                            ...
                            <div className="">
                                ...
                                <p>
                                    The materials in this class consist of
                                    videos and texts. Why is that? Because we
                                    have found that in the learning process in
                                    the field of mathematics, the most effective
                                    form of learning materials to be remembered,
                                    understood, and most importantly, practiced
                                    for your child is in the form of videos.
                                </p>
                            </div>
                        </Col>
                    </Col>
                    <Col sm={4} className="">
                        <div>
                            ...
                            <Link to="/value" className="btn btn-primary">
                                Finish
                            </Link>
                        </div>
                        {/* Camera */}
